...
BMP *bmp_create(FILE *fin) {
    ...
    if (pbmp == NULL) {
        fprintf(stderr, "fatal error could not create BMP");
        exit(1);
    }
    ...
    read_uint32(fin, &throw32);
    read_uint16(fin, &throw16);
    read_uint32(fin, &throw32);
    read_uint16(fin, &throw16);
